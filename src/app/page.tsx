    ...
    <div className="min-h-screen bg-gradient-to-br from-yellow-100 via-yellow-50 to-white flex flex-col items-center font-sans">
      ...
      <main className="flex-1 w-full max-w-4xl px-4 py-12">
        <section className="mb-12 text-center">
          ...
          <p className="text-yellow-900 text-lg mb-4">Yellow dragon fruit (Hylocereus megalanthus), also known as Pitahaya Amarillo, is a rare, sweet, and highly nutritious tropical fruit native to Mexico, Central and South America. The fruit is oval to elliptical, smaller than red and pink varieties, with thick, golden-yellow skin covered in small knobby protrusions. Its white, translucent flesh is dense, crisp, and juicy, with a texture reminiscent of a cross between kiwi and pear. Tiny edible black seeds add a pleasant crunch. The flavor is mild, sweet, slightly tangy, with floral and fruity notes. The fruit is best enjoyed when soft to the touch and heavy for its size, indicating high juice content. The skin is not edible and should be discarded.</p>
          <p className="text-yellow-900 text-base mb-2">Yellow dragon fruit is available year-round, with peak seasons varying by region. It is grown commercially in Mexico, Colombia, Ecuador, Peru, Costa Rica, Vietnam, China, Thailand, Australia, Israel, and the United States (Florida, California, Hawaii). The fruit has a rich history, used by Mayan and Aztec civilizations, and was introduced to Asia in the 19th century. Today, it is prized worldwide for its unique taste, nutritional value, and versatility in both fresh and cooked preparations.</p>
        </section>
